...
<div class="module widget-handle cart-widget-handle left">
    ...
    <a href="<?php echo esc_url($cart_url); ?>" class="cart">
        <i class="ti-bag"></i>
        <span class="label number"><span class="ebor-count"><?php echo wp_kses_post($woocommerce->cart->get_cart_contents_count()); ?></span></span>
        ...
        <div class="widget">
            ...
            <div class="cart-controls">
                ...
                <div class="list-inline pull-right">
                    ...
                    <span class="number ebor-number"><?php echo wp_kses_post($woocommerce->cart->get_cart_total()); ?></span>
                </div>
            </div>
