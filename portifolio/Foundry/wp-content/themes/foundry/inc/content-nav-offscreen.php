	...
	<nav class="absolute transparent" <?php echo wp_kses_post($fixed_at_html); ?>>
		...
		<div class="offscreen-container bg-dark text-center">
			...
			<div class="v-align-transform text-center">
				...
				<p class="fade-half">
					<?php echo wpautop(wp_kses_post(get_option('foundry_footer_copyright', '<a href="http://www.tommusrhodus.com">Foundry Premium WordPress Theme by TommusRhodus</a>')), ebor_allowed_tags()); ?>
				</p>
