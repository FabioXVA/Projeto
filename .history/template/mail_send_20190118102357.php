<?php
  ...
  $mensagem = pegaValor("mensagem");
	define('GUSER', 'http://agenciaestro.com/');	define('GPWD', 'T02967010');
...
if ($enviado) {
    ...
    // exit;     
     ...
     echo "<span style='color: #721c24;background-color: #f8d7da;border-color: #c3e6cb;padding: .75rem 1.25rem;display: block;margin: 30% auto;text-align: center;border: 1px solid transparent;border-radius: .25rem;width: 90%;'>Houve um erro enviando o E-mail</span>";
}
