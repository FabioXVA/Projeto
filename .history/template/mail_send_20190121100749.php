...
include "../assets/mail/PHPMailerAutoload.php";
...
$mail->Host = "smtp.cryah.com.br"; // Você pode alterar este parametro para o endereço de SMTP do seu provedor$mail->Host = "smtp.gmail.com"; // Você pode alterar este parametro para o endereço de SMTP do seu provedor
$mail->Port = 587; 
//$mail->Port = 25; 
 
$mail->SMTPAuth = true; // Usar autenticação SMTP (obrigatório)$mail->SMTPSecure = 'ssl'; // Obrigatório para o Gmail
$mail->Username = 'contato@cryah.com.br'; // Usuário do servidor SMTP (endereço de email)$mail->Username = GUSER; // Usuário do servidor SMTP (endereço de email)
$mail->Password = 'bloqueio2018'; // Mesma senha da sua conta de email$mail->Password = GPWD; // Mesma senha da sua conta de email
...
// Define o remetente
$mail->From = "contato@cryah.com.br"; // Seu e-mail
$mail->FromName = "Cryah"; // Seu nome
 
// Define o(s) destinatário(s)
$mail->AddAddress('contato@cryah.com.br', 'Cryah Jet');
...
// Assunto da mensagem
$mail->Subject = "Email enviado do formulario da jet"; 
 
// Corpo do email
$mail->Body = '<strong> Nome: '.$de.'</strong><br><br> <strong>E-mail: </strong>'.$email.'<br><br> <strong>Telefone: </strong>'. $fone.'<br><br> <strong>Mensagem: </strong>'. $mensagem;
