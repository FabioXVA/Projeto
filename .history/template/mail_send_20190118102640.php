...
if ($enviado) {
    ...
    // exit;     
     ...
     echo '<meta name="viewport" content="width=device-width, initial-scale=1">';
     echo "<h1 style='color: #721c24;background-color: #f8d7da;border-color: #c3e6cb;padding: 2rem 1.25rem;display: block;margin: 45% auto;text-align: center;border: 1px solid transparent;border-radius: .25rem;width: 90%; font-size:3rem;'>Houve um erro enviando o E-mail</h1>";
}
