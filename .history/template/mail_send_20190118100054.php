...
$mail->Username = 'contato@infinito.etc.br'; // Usuário do servidor SMTP (endereço de email)$mail->Username = GUSER; // Usuário do servidor SMTP (endereço de email)
$mail->Password = 'inFINITO**'; // Mesma senha da sua conta de email$mail->Password = GPWD; // Mesma senha da sua conta de email
...
if ($enviado) {
     echo "<span style='color: #93cdf2;background-color: #38004e;border-color: #c3e6cb;padding: .75rem 1.25rem;display: block;margin: 20% auto;text-align: center;border: 1px solid transparent;border-radius: .25rem;width: 300px;'>Seu E-mail foi enviado com sucesso!</span>";
