...
$mail->Username = 'contato@agenciestro.com.br'; // Usuário do servidor SMTP (endereço de email)$mail->Username = GUSER; // Usuário do servidor SMTP (endereço de email)
...
// Define o remetente
$mail->From = "contato@agenciestro.com.br"; // Seu e-mail
$mail->FromName = "Cryah"; // Seu nome
 
// Define o(s) destinatário(s)
$mail->AddAddress('contato@agenciestro.com.br', 'Agencia Estro');
...
// Assunto da mensagem
$mail->Subject = "Email enviado do formulario do site Agencia Estro"; 
