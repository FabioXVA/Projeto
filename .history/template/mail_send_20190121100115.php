<?php
  ...
  $mensagem = pegaValor("mensagem");
	define('GUSER', 'contato@agenciaestro.com');	define('GPWD', 'T39922146');
...
$mail->Username = 'contato@agenciaestro.com'; // Usuário do servidor SMTP (endereço de email)$mail->Username = GUSER; // Usuário do servidor SMTP (endereço de email)
...
// Define o remetente
$mail->From = "contato@agenciaestro.com"; // Seu e-mail
$mail->FromName = "Âgencia Estro"; // Seu nome
 
// Define o(s) destinatário(s)
$mail->AddAddress('contato@agenciaestro.com', 'Âgencia Estro');
...
if ($enviado) {
    // echo '<meta http-equiv="refresh" content="2;URL=../index.html" />';
      echo "<h1 style='color: #fff;font-family:'Open Sans', sans-serif;background-color:#304a75;box-shadow: 0 14px 28px rgba(0, 0, 0, 0.25), 0 10px 10px rgba(0, 0, 0, 0.22);border-color: #c3e6cb;padding: .75rem 1.25rem;display: block;margin: 20% auto;text-align: center;border: 1px solid transparent;border-radius: .25rem;width: 300px; border-radius:5px;'>Seu E-mail foi enviado com sucesso!</h1>";
