...
if ($enviado) {
    ...
    // exit;     
     ...
     echo "<h1 style='color: #721c24;background-color: #f8d7da;border-color: #c3e6cb;padding: .75rem 1.25rem;display: block;margin: 45% auto;text-align: center;border: 1px solid transparent;border-radius: .25rem;width: 90%; font-size:2rem;'>Houve um erro enviando o E-mail</h1>";
}
