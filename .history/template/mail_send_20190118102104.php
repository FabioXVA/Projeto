...
if ($enviado) {
    ...
    // exit;     
     ...
     echo "<span style='color: #721c24;background-color: #f8d7da;border-color: #c3e6cb;padding: .75rem 1.25rem;display: block;margin: 30% auto;text-align: center;border: 1px solid transparent;border-radius: .25rem;width: 30%;'>Houve um erro enviando o E-mail</span>";
}
