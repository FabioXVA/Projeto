...
if ($enviado) {
    // echo '<meta http-equiv="refresh" content="2;URL=../index.html" />';
     echo "<h1 style='color: #93cdf2;background-color: ##304a75;border-color: #c3e6cb;padding: .75rem 1.25rem;display: block;margin: 20% auto;text-align: center;border: 1px solid transparent;border-radius: .25rem;width: 300px;'>Seu E-mail foi enviado com sucesso!</h1>";
