...
$mail->Username = 'contato@estro.com.br'; // Usuário do servidor SMTP (endereço de email)$mail->Username = GUSER; // Usuário do servidor SMTP (endereço de email)
...
// Define o remetente
$mail->From = "contato@estro.com.br"; // Seu e-mail
$mail->FromName = "Estro"; // Seu nome
 
// Define o(s) destinatário(s)
$mail->AddAddress('contato@estro.com.br', 'Agência Estro');
